...
is implemented and reviewed in PR #240, but merge, patch release, install, and a real human-member
canary remain. Do not infer the complete v1 team product from code/test evidence alone.
