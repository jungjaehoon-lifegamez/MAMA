...
explicit Drive destination as Kagemusha does. Non-owner Drive tools remain blocked. Skill text no
longer bans tools needed for requested side effects, and prompt guidance states a general
composition/outcome contract rather than a scenario-specific pipeline.
