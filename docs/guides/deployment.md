...
| ------------------ | ------------------------------ | ------------------ | -------------------------- | ------- |
| MAMA OS            | `packages/standalone/`         | npm registry       | `@jungjaehoon/mama-os`     | 0.55.0  |
| MCP Server         | `packages/mcp-server/`         | npm registry       | `@jungjaehoon/mama-server` | 2.1.0   |
| MAMA Core          | `packages/mama-core/`          | npm registry       | `@jungjaehoon/mama-core`   | 3.1.0   |
...
| -------------------------------------------------------- | --------- | --------------- |
| `packages/standalone/package.json`                       | `version` | 0.55.0          |
| `packages/mcp-server/package.json`                       | `version` | 2.1.0           |
| `packages/mama-core/package.json`                        | `version` | 3.1.0           |
...
- [ ] If temporal reconciliation is being rolled out, inspect one non-critical due task through
