...
| ------------------ | ------------------------------ | ------------------ | -------------------------- | ------- |
| MAMA OS            | `packages/standalone/`         | npm registry       | `@jungjaehoon/mama-os`     | 0.40.0  |
| MCP Server         | `packages/mcp-server/`         | npm registry       | `@jungjaehoon/mama-server` | 1.15.0  |
| MAMA Core          | `packages/mama-core/`          | npm registry       | `@jungjaehoon/mama-core`   | 2.2.3   |
...
| -------------------------------------------------------- | --------- | --------------- |
| `packages/standalone/package.json`                       | `version` | 0.40.0          |
| `packages/mcp-server/package.json`                       | `version` | 1.15.0          |
| `packages/mama-core/package.json`                        | `version` | 2.2.3           |
