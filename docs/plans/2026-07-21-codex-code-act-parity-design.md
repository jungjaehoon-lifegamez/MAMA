...
5. A change only to the effective inner role/tier surface invalidates stale thread policy and requires explicit reset.
...
- Broadening connector scope beyond verified owner-console Trello reads.
