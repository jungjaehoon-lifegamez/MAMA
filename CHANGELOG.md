...
- Owner policy fingerprints use the effective model. An omitted background model and an
  explicitly identical Telegram model no longer replace the same owner thread on channel changes.
