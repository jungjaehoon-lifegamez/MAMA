...
| **Now**            | v0.40.0 repairs the cognitive foundation under owner reports: `decisions.status` is the only current memory authority, the full report is composed from one host-authored evidence packet in one model turn, and task lifecycle judgments are evidence-bound with revision checks. The installed real-report gate and the Phase 2b human-member canary remain open until they pass on a live runtime. |
| Next               | Unpacked below.                                                                                                                                                                                                                                                                                                                                                                                       |
