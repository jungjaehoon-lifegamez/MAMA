...
| **Now**            | v1.0 Phase 2b is the current implementation slice and is not shipped yet. Phase 1 sender authentication and Phase 2a durable owner/member principals are shipped foundations, not the complete team product.                                                                                                                                                             |
| Next               | Unpacked below.                                                                                                                                                                                                                                                                                                                                                          |
