...
| **Now**            | v0.42.0 closes the learning loop of One MAMA: an owner rule or correction stated in chat becomes a `policy:` or `lesson:` memory row written by the host (the agent cannot write those topics) and is injected into every later event, scheduled and chat turn. v0.41.0 made the owner-event turn change the ledger, with completion defined as a ledger change, and collapsed the scheduled lanes onto one `owner_console` principal. Installed acceptance of both is recorded in the parity doc as it lands. |
| Next               | Unpacked below.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
