...
| --------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------- |
| [mama-os](packages/standalone/) 0.39.4        | The always-on server: connectors, trigger loop, reports, task board, and web UI. "MAMA" means this.            | `mama start`         |
| [mama-core](packages/mama-core/) 2.2.1        | The library underneath: memory, provenance, graph, embeddings. Everything imports it; it imports nothing here. | No binary            |
...
| **Now**            | v0.39.4 packages the v1.0 Phase 2b release candidate merged in [PR #240](https://github.com/jungjaehoon-lifegamez/MAMA/pull/240), including Core 2.2.1 migration 065 and the principal-grant repository required by installed runtimes. Phase 2b is not called shipped until local install, restart validation, and a real human-member canary pass.                     |
| Next               | Unpacked below.                                                                                                                                                                                                                                                                                                                                                          |
