...
- **console_brief_update**(content) — Rewrite YOUR owner-console operating brief (full replace): record a dated lesson whenever the owner corrects your working style or a recipe proves wrong. Keep existing content; never delete the owner's edits.
