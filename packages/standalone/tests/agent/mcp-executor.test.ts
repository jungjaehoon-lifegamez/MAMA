...
describe('MCPExecutor', () => {
  ...
  describe('execute()', () => {
    it('should throw error for unknown tool', async () => {
      const executor = new MCPExecutor({ mamaApi: createMockApi() });
  ...
  describe('mama_save tool', () => {
    it('should save decision', async () => {
      const mockApi = createMockApi();
      const executor = new MCPExecutor({ mamaApi: mockApi });
  ...
  describe('mama_load_checkpoint tool', () => {
  ...
  describe('static methods', () => {
    it('should return valid tools', () => {
      const tools = MCPExecutor.getValidTools();
    ...
    it('should check valid tool names', () => {
      expect(MCPExecutor.isValidTool('mama_save')).toBe(true);
      expect(MCPExecutor.isValidTool('mama_search')).toBe(true);
      expect(MCPExecutor.isValidTool('mama_update')).toBe(true);
      expect(MCPExecutor.isValidTool('mama_load_checkpoint')).toBe(true);
      expect(MCPExecutor.isValidTool('Read')).toBe(true);
      expect(MCPExecutor.isValidTool('discord_send')).toBe(true);
      expect(MCPExecutor.isValidTool('invalid')).toBe(false);
    });
  });
});
