...
const CLINE_MODEL_OPTIONS = ['deepseek/deepseek-v4-flash'];
export const MANAGED_AGENT_BACKENDS = ['claude', 'codex', 'cline'] as const;
...
export class AgentsModule {
  ...
  private renderConfigTab(el: HTMLElement, a: AgentWithVersion): void {
    ...
    const backendOptions = Array.from(new Set([...MANAGED_AGENT_BACKENDS, backend]))
      .map(
        (b) =>
