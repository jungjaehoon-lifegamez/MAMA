...
export class GraphModule {
     ...
     */
    async fetchData(params = { limit: INITIAL_GRAPH_LIMIT }) {
        try {
    ...
    async showDetail(node) {
        try {
            ...
            decisionEl.innerHTML = renderSafeMarkdown(String(detailNode.decision || detailNode.decision_preview || '-'));
    ...
    populateTopicFilter(topics) {
        const datalist = getElementByIdOrNull('topic-filter-list');
        if (!datalist) {
