...
let chatModule = null; // Chat module instance (initialized after DOM loads)
let network = null;
...
// =============================================
// Chat Module (Story 2-3, 2-4, 2-5, 3-1) - Refactored to js/modules/chat.js
// =============================================
// All Chat functionality now handled by ChatModule class:
// - WebSocket chat with Claude Code CLI
// - Voice input (Web Speech API)
// - Streaming responses with RAF batching
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Initialize Chat module (Phase 4 refactoring)
  chatModule = new ChatModule(memoryModule);
  window.chatModule = chatModule; // For HTML onclick handlers
...
// Chat module exports (delegate to chatModule instance)
