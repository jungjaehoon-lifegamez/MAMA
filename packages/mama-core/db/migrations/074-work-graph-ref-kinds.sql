-- Extend work-graph reference kinds without rewriting edge identity or provenance.
ALTER TABLE twin_edges RENAME TO twin_edges_legacy_074;
...
INSERT INTO twin_edges SELECT * FROM twin_edges_legacy_074;
DROP TABLE twin_edges_legacy_074;
...
VALUES (74, 'Registry and observation work graph references');
